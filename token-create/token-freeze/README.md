...
トークンミントアカウントを作成する時にフリーズできる権限を持たせるアドレスを指定することができ、そこで指定したアドレスのみがトークンアカウントをフリーズすることができます。指定しないとトークンのフリーズはできません。
...
4. フリーズできましたね。これで設定したアソシエイティドトークンアカウント、今0.5トークンあるアカウントがフリーズされました。
